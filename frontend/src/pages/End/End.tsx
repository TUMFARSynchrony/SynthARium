    ...
    <div className="h-screen flex flex-col mx-8 py-4 items-start text-left gap-y-4 xl:items-center">
      ...
      <div className="flex flex-col h-full overflow-y-auto justify-center gap-y-4 xl:w-1/2">
        ...
        <p className="text-justify">
          This is the end of the study. Thank you for your participation. Lorem
          ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
          veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
          ea commodo consequat. <br /> You can contact Dr. Max Mustermann via
          maxmustermann@gmail.com. <br /> To fill out the <b>end survey</b>,
          click the continue button. The survey will open in another tab.
        </p>
      </div>
